...
// ============================================================================
//  🆕 SIGNATURE DE BUILD (diagnostic OTA)
// ============================================================================
...
Programmateur programmateurs[] = {
  { "1.", "Programmation 1", "Cuisine",  "#f59e0b", 32, "09:05", "12:30", true, false, 14 }, //#f59e0b est un code couleur hexadécimal R V B
  { "2.", "Programmation 2", "Portail",  "#06b6d4", 33, "07:50", "13:15", true, false, 16 },
  { "3.", "Programmation 3", "Relais 3", "#0CE892", 25, "06:20", "00:26", true, false, 17 },
  { "4.", "Programmation 4", "Relais 4", "#ef4444", 26, "10:30", "01:05", true, false, 18 },
...
void setupOTA() {
  ...
  ArduinoOTA.onStart([]() {
    ...
    if (oledOK) {
      ...
      display.display();
      // 🔧 Raccourci de 2500 ms a 400 ms : un blocage aussi long juste au
      // debut du transfert OTA n'apporte rien (le message reste affiche
      // jusqu'a la 1ere mise a jour de la barre de progression) et augmente
      // inutilement le risque de watchdog / timeout cote outil OTA.
      delay(1500);
    }
  });
